...
cleos wallet import --private-key 5JmBnFBTBHAuhgX7iAxNnb5SEUpyBiYqNrh789XWBujN6iXU8dG # fraxreserves
cleos wallet import --private-key 5Jka9J9sthYAGHAJYJEYVuZSSnuTgpqV5WMaMMxow5MRqDUWRGt # tethertether
cleos wallet import --private-key 5Jn4z4UhDh68GZREnDpBtMXPAx96d3CX7mLgSbUTca4eEUZNxho # fraxfitokens
cleos wallet import --private-key 5HpMNASust7Negki66DJ5benpQAsXBRM3jDpHe8eREddYctA5mF # fraxloanfrax
...
cleos system newaccount eosio fraxreserves EOS6jA39vSMGVHVQzxhYhE9gMToCYG9U9QLZiWZschCgfQuKJ6nrF --stake-cpu "50 EOS" --stake-net "10 EOS" --buy-ram-kbytes 5000 --transfer
cleos system newaccount eosio fraxloanfrax EOS6DcmhfH9RSEftsRa6k8uH7E76sLRtj3hFPyVRLoNDEBdZE1anc --stake-cpu "50 EOS" --stake-net "10 EOS" --buy-ram-kbytes 5000 --transfer
...
cleos system newaccount eosio fraxfitokens EOS7vr4QpGP7ixUSeumeEahHQ99YDE5jiBucf1B2zhuidHzeni1dD --stake-cpu "50 EOS" --stake-net "10 EOS" --buy-ram-kbytes 5000 --transfer
...
cleos set contract fraxfitokens $EOSIO_CONTRACTS_ROOT/eosio.token/
...
cleos push action fraxfitokens create '[ "fraxfitokens", "1000000.0000 FXS" ]' -p fraxfitokens # 1M cap fixed supply
cleos push action fraxfitokens issue '[ "fraxfitokens", "1000000.0000 FXS", "issue FXS" ]' -p fraxfitokens
cleos push action fraxfitokens transfer '["fraxfitokens", "dcbtestusera", "10000.0000 FXS", "memo"]' -p fraxfitokens
cleos push action fraxfitokens transfer '["fraxfitokens", "dcbtestuserb", "10000.0000 FXS", "memo"]' -p fraxfitokens
cleos push action fraxfitokens transfer '["fraxfitokens", "dcbtestuserc", "10000.0000 FXS", "memo"]' -p fraxfitokens
cleos push action fraxfitokens transfer '["fraxfitokens", "dcbtestuserd", "10000.0000 FXS", "memo"]' -p fraxfitokens
cleos push action fraxfitokens transfer '["fraxfitokens", "dcbtestusere", "10000.0000 FXS", "memo"]' -p fraxfitokens
...
cleos set account permission fraxreserves active '{ "threshold": 1, "keys": [{ "key": "EOS6jA39vSMGVHVQzxhYhE9gMToCYG9U9QLZiWZschCgfQuKJ6nrF", "weight": 1 }], "accounts": [{ "permission": { "actor":"fraxreserves","permission":"eosio.code" }, "weight":1 } ] }'
cleos set account permission fraxloanfrax active '{ "threshold": 1, "keys": [{ "key": "EOS6DcmhfH9RSEftsRa6k8uH7E76sLRtj3hFPyVRLoNDEBdZE1anc", "weight": 1 }], "accounts": [{ "permission": { "actor":"fraxloanfrax","permission":"eosio.code" }, "weight":1 } ] }'
