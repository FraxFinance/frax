...
public:
    ...
    struct [[eosio::table]] account {
      asset balance;
      asset borrowing;
      uint64_t interest_counter_start;
    ...
    struct [[eosio::table]] stats_t {
        ...
        uint64_t last_interest_update;
        double interest_rate_lower;
        double interest_rate_upper;
        double loan_limit; // max percentage of available supply that can be loaned
